...
work_dir = '/network/scratch/t/tengmeli/RSPrompter_bci-dsm/'
crop_size = (1024, 1024)
default_hooks = dict(
...
test_out_dir="/network/scratch/t/tengmeli/RSPrompter_bci-dsm/"
...
train_dataloader = dict(
    ...
    dataset = dict(
        type=dataset_type,
        data_root='',
        ann_file="/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_dsm_train_new.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root="",
        ann_file="/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_dsm_val_new.json",
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root="",
        ann_file="/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_dsm_test_new.json",
        pipeline =test_pipeline
    )
)
