...
work_dir = '/network/scratch/t/tengmeli/RSPrompter_final/rsprompter-anchor-trees-base'
crop_size = (1024, 1024)
default_hooks = dict(
...
test_out_dir="/network/scratch/t/tengmeli/RSPrompter_clean/rspromter_anchor_trees_lowlr_preds/" 

vis_backends = [#dict(type='LocalVisBackend'),
               dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-final', group='rsprompter-final', name='rsprompter-anchor-trees-base', resume="allow", id="rsprompter-anchor-trees-lowlr",  allow_val_change=True))
                ]
visualizer = dict(
