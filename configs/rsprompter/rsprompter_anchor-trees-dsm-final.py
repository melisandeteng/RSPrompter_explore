...
work_dir = '/network/scratch/t/tengmeli/RSPrompter_final/rsprompter-anchor-trees-base-dsm-final'
crop_size = (1024, 1024)
default_hooks = dict(
...
test_out_dir="/network/scratch/t/tengmeli/RSPrompter_final/rsprompter-anchor-trees-base-dsm-final"
