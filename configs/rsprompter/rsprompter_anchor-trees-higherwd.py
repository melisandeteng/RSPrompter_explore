...
work_dir = '/network/scratch/t/tengmeli/RSPrompter_clean/rspromter_anchor_trees_higherwd'
crop_size = (1024, 1024)
default_hooks = dict(
...
test_out_dir="/network/scratch/t/tengmeli/RSPrompter_final/rspromter_anchor_trees_higherwd_preds" 
