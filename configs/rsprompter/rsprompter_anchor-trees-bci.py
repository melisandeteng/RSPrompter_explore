...
work_dir = '/network/scratch/t/tengmeli/RSPrompter_bci/lowlr'
test_out_dir="/network/scratch/t/tengmeli/RSPrompter_bci/lowlr" 
...
train_datasets_list = [
    dict(
        type=dataset_type,
        data_root='',
        ann_file= "/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_train_new.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root="",
        ann_file= "/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_val_new.json",
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root="",
        ann_file= "/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family/merged_annots_test_new.json",
        pipeline=test_pipeline,
        #data_prefix=dict(img='tiles/'),
    )
)
