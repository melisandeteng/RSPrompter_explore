...
vis_backends = [#dict(type='LocalVisBackend'),
               dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-sbl-final-test', group='rsprompter-baselr', name='rsprompter-anchor-trees-baselr', resume="allow", id="rsprompter-anchor-trees-baselr",  allow_val_change=True))
                ]
visualizer = dict(
